...
class AlarmReceiver : BroadcastReceiver() {
    ...
    //TODO Мб можно у notify разные айдишники ставить чтобы много уведомлений выводилось
    ...
    private fun sendNotification(context: Context, event: Intent) {
        val event_id = event.getIntExtra("event_id", 123)
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_celebration_24dp)
